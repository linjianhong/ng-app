!(function (window, angular, undefined) {
  ...
  var theDefault = {
    ...
    form: {
      items: [
        { name: 'content', title: '评论', type: 'textarea', param: { valid: { required: true }, placeholder: "在此发表评论" } },
        { name: 'pics', title: '图片', type: 'imgs-uploader' },
        //{ name: 'star1', title: '交货期', type: 'star', param: { valid: { required: true } } },
        //{ name: 'star2', title: '质量', type: 'star', param: { valid: { required: true } } },
        //{ name: 'star3', title: '服务配合', type: 'star', param: { valid: { required: true } } },
        //{ name: 'star4', title: '安全管理', type: 'star', param: { valid: { required: true } } },
        //{ name: 'star5', title: '环保管理', type: 'star', param: { valid: { required: true } } },
      ],
      templates___: {
